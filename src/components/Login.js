...
// {/* ENTIRE SCREEN BACKGROUND (Option 3 Colors applied globally) */}
    <div className="min-h-screen flex w-full font-sans bg-gradient-to-br from-sky-100 via-white to-blue-50 relative overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col relative z-10">
        <div className="flex flex-col items-center justify-center h-full p-12 w-full max-w-2xl lg:ml-auto lg:mr-2 xl:mr-2">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <h1 className="text-3xl font-extrabold text-slate-800 tracking-tight">Exam Ease Proctor</h1>
          </div>
          <p className="text-slate-600 text-lg mb-10 text-center font-medium">Secure Testing, Simplified. Sign in to your account.</p>

          <div className="relative w-full max-w-md lg:max-w-lg mx-auto h-[450px] mb-12 mt-8">
            ...
            {/* Card 1: Exam Creation (Light Card, Top Left) */}
            <div className="absolute top-0 left-0 w-64 h-72 bg-white/70 backdrop-blur-xl rounded-3xl border border-white shadow-2xl transform -rotate-3 hover:rotate-0 hover:-translate-y-2 transition-all duration-500 z-10">
              ...
              {/* IMAGE WRAPPER - This is where the magic happens! 
                  The negative top margin (-top-16) makes her pop out of the card. */}
            ...
            {/* Card 2: AI Proctoring (Dark Card, Bottom Right) */}
            <div className="absolute bottom-0 right-0 w-64 h-72 bg-slate-800/90 backdrop-blur-xl rounded-3xl border border-slate-700 shadow-2xl transform rotate-3 hover:rotate-0 hover:-translate-y-2 transition-all duration-500 z-20">
              ...
              {/* IMAGE WRAPPER - Negative margins make him pop out */}
      ...
      {/* Note: I removed the bg colors from here so it inherits the beautiful gradient from the main wrapper! */}
      <div className="w-full lg:w-1/2 flex flex-col justify-center py-12 px-6 sm:px-12 lg:pl-8 lg:pr-24 xl:pl-16 xl:pr-32 relative z-10">
        
        {/* The "Glassmorphism" Login Card */}
        <div className="relative w-full max-w-md mx-auto lg:ml-0 bg-white py-10 px-8 shadow-2xl shadow-slate-200 sm:rounded-3xl border border-slate-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
                {/* 1. Label goes outside the relative div */}
